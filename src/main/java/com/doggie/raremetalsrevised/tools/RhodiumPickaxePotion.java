...
public class RhodiumPickaxePotion extends PickaxeItem {



    public RhodiumPickaxePotion(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builder) {
...
public class Boi extends ArmorItem {
    ...
    public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
        ...
        if (livingEntity.getHeldItemMainhand().getItem()  == RhodiumMaterial.rhodium_pickaxe
