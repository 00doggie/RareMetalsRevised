...
public class CaliforniumPickaxePotion extends PickaxeItem {



    public CaliforniumPickaxePotion(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builder) {
    ...
    public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
        ...
        if (livingEntity.getHeldItemMainhand().getItem()  == CaliforniumMaterial.californium_pickaxe
