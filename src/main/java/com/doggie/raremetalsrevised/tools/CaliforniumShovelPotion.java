...
public class CaliforniumShovelPotion extends ShovelItem {


    public CaliforniumShovelPotion(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder) {
    ...
    public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
        ...
        if (livingEntity.getHeldItemMainhand().getItem()  == CaliforniumMaterial.californium_shovel
