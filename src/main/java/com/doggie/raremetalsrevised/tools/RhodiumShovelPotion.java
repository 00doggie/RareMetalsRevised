...
public class RhodiumShovelPotion extends ShovelItem {


    public RhodiumShovelPotion(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder) {
    ...
    public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
        ...
        if (livingEntity.getHeldItemMainhand().getItem()  == RhodiumMaterial.rhodium_shovel
