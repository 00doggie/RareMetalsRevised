        ...
        public class RegistryHandler {
                ...
                public class Armor extends ArmorItem {
                        public Armor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
                                super(materialIn, slot, builder);
                        }

                        @Override
                        public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
                                if (stack.getItem() == (RegistryHandler.rhodium_chestplate)) {
                                        player.addPotionEffect(new EffectInstance(Effects.SPEED, 60, 3, false, false));
                                }
